...
- `ZodiacRing.vue`, `ElementLegend.vue`, `TickRing.vue`, `HouseCusps.vue`, `HouseNumbers.vue`: outer ring, tropical element legend, ruler, house geometry, and labels.
...
- `geometry.js`: shared radii, symbols, aspect colors, coordinate math, and map normalization.
