...
export const centerText = {
  Head: 'rgba(15,23,42,0.62)',
  Ajna: 'rgba(15,23,42,0.58)',
  Throat: 'rgba(15,23,42,0.58)',
  G: '#6f6a30',
  Ego: 'rgba(127,29,29,0.64)',
  'Solar Plexus': 'rgba(15,23,42,0.58)',
  Spleen: 'rgba(15,23,42,0.58)',
  Sacral: 'rgba(127,29,29,0.64)',
  Root: 'rgba(15,23,42,0.58)',
}
