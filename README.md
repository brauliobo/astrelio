...
Static builds are emitted to `docs/` by default for GitHub Pages. Do not commit generated `dist/` output.
...
Do not commit generated `dist/` output for deploys. Use `docs/` for committed static Pages artifacts.
